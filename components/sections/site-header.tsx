...
export function SiteHeader() {
  ...
  return (
    ...
    >
      <div className="section-padding-x mx-auto flex max-w-6xl flex-col items-start gap-3 py-3 sm:flex-row sm:items-center sm:justify-between sm:gap-4">
        <Link
          href="#top"
          data-cursor={navCursor("#top")}
          className="flex min-h-11 shrink-0 items-center font-[family-name:var(--font-display)] text-base font-black uppercase tracking-tight sm:min-h-0 sm:text-lg"
        >
          {site.name}
        </Link>
